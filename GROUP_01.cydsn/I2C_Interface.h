...
*/
    ...
    */
    ErrorCode I2C_Peripheral_ReadRegister(uint8_t device_address, 
                                          ...
                                          uint8_t* data); // in questo caso leggiamo un solo byte, altrimenti dobbiamo mettere l'array con il numero di byte che vogliamo leggere
    // la funzione serve per leggere who am i register and control register
